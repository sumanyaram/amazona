                    ...
                    (
                        <>
                            ...
                            <div>
                                ...
                                <input type="text" id="name" placeholder="Enter user name" value={name} onChange={e => setName(e.target.value)}></input>
                            </div>
                            <div>
                            ...
                            <div>
                                ...
                                <input type="password" id="confirmPassword" placeholder="Enter confirm password" onChange={e => setConfirmPassword(e.target.value)}></input>
                            </div>
                            <div>
                                <label />
