...
export const detailsUser = (userId) => async(dispatch, getState) => {
    ...
    try
    {
        ...
        if (!userInfo) {
            dispatch({type: USER_DETAILS_FAIL, payload: "User not logged in." });
            return;
        }
...
export const listUsers = () => async(dispatch, getState) => {
    ...
    try
    {
        ...
        if (!userInfo) {
            dispatch({type: USER_LIST_FAIL, payload: "User not logged in." });
            return;
        }
...
export const deleteUser = (userId) => async(dispatch, getState) => {
    ...
    try
    {
        ...
        if (!userInfo) {
            dispatch({type: USER_DELETE_FAIL, payload: "User not logged in." });
            return;
        }
